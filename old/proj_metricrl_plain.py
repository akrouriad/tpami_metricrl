...
if __name__ == '__main__':
    log_name = rllog.generate_log_folder('hopper_bul', 'projection', 'unbounded',  timestamp=True)
    learn(envid='HopperBulletEnv-v0', max_ts=3e6, seed=0, norma='None', log_name=log_name)
